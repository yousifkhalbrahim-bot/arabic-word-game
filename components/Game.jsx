    ...
    <div className="flex flex-col" style={{ position: 'fixed', inset: 0, overflow: 'hidden', background: '#0c0c1a', color: '#fff', userSelect: 'none' }}>
      ...
      <div className="flex-1 flex gap-2 px-3 pt-1 pb-2 min-h-0 overflow-hidden">
        ...
        <div className="flex flex-col rounded-2xl overflow-hidden"
          style={{ width: '27%', maxHeight: '55vh', alignSelf: 'flex-start', background: 'rgba(255,255,255,0.03)', border: `1px solid ${myColor}25` }}>
        ...
        <div className="flex flex-col rounded-2xl overflow-hidden"
          style={{ width: '27%', maxHeight: '55vh', alignSelf: 'flex-start', background: 'rgba(255,255,255,0.03)', border: `1px solid ${oppColor}25` }}>
      ...
      {/* ===== الإدخال ===== */}
      <div className="shrink-0 px-3 pb-2 pt-0">
        {localFeedback && (
